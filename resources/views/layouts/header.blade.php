    ...
    <section class="relative">
        ...
        <div id="mobileMenu"
            ...
            <div class="flex flex-col px-10 pt-12 space-y-8">
                ...
                <a href=""
                    class="relative font-semibold text-base text-white transition-all duration-300 hover:translate-x-5">Portfolio</a>
                <a href=""
                    class="relative font-semibold text-base text-white transition-all duration-300 hover:translate-x-5">Blog</a>
                <a href="{{ route('contact') }}"
